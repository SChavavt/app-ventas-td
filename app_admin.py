...
with tab3:
    ...
    # Usar directamente Tipo_Envio para filtrar devoluciones
    ...
    df_devoluciones = df_casos[df_casos["Tipo_Envio"].astype(str).str.contains("Devoluci", case=False, na=False)].copy()
