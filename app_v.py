    ...
    if should_process_submission:
        ...
        try:
            ...
            if not uploaded_files:
                if not allow_without_attachments:
                    st.warning(
                        "Intento de subir pedido sin archivos. Adjunte uno o, si no es necesario, presione 'Continuar sin adjuntos'."
                    )
