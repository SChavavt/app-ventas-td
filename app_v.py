...
with tab1:
    ...
    skip_local_route_logic_for_tab1_user = (
        tab1_special_shipping
        and tipo_envio_ui == "📍 Local CDMX"
        and id_vendedor_tab1 in TAB1_LOCAL_CDMX_DISABLE_ROUTE_IDS
    )
    usa_hoja_ruta_local = usa_logica_local and not skip_local_route_logic_for_tab1_user
    if usa_logica_local:
        ...
        if not usa_hoja_ruta_local:
            ...
            st.caption(
                "ℹ️ Para este usuario en **📍 Local CDMX** la captura de hoja de ruta está deshabilitada en Tab 1."
            )
