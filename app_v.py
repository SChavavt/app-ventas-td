...
with tab1:
    ...
    local_route_download_placeholder = None
    ...
    with st.form(key=f"new_pedido_form_{form_nonce}", clear_on_submit=False):
        ...
        if tipo_envio == "📍 Pedido Local":
            ...
            local_route_download_placeholder = st.empty()
    ...
    if tipo_envio == "📍 Pedido Local":
        ...
        route_download_target = local_route_download_placeholder or st.empty()
        with route_download_target.container():
            st.markdown("#### 📄 Generar Hoja de Ruta")
