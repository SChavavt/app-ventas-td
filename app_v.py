...
with tab1:
    ...
    with st.form(key="new_pedido_form", clear_on_submit=True):
        ...
        if tipo_envio in ["🚚 Pedido Foráneo", "🏙️ Pedido CDMX", "📍 Pedido Local"]:
            ...
            requiere_captura_pago = (not registrar_nota_venta) or (estado_pago == "✅ Pagado")
...
with tab4:
    ...
    if df_casos.empty:
        ...
        pendientes_autorizados = obtener_devoluciones_autorizadas_sin_folio(id_vendedor_sesion)
