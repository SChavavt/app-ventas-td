...
def render_birthday_entry_surprise() -> None:
    ...
    if not st.session_state.get(BIRTHDAY_ENTRY_EVENT_KEY):
        st.balloons()
        st.toast(f"🎂 ¡Feliz cumpleaños, {BIRTHDAY_VENDOR_NAME}!")
    ...
    st.markdown(
        ...
        <div class="birthday-hero" role="status" aria-label="Mensaje de cumpleaños">
            ...
            <div class="birthday-hero__eyebrow">Hoy la app se viste de fiesta</div>
            <div class="birthday-hero__title">¡Feliz cumpleaños, {html.escape(BIRTHDAY_VENDOR_NAME)}!</div>
            <div class="birthday-hero__message">
                Que cada pedido de hoy te recuerde lo especial que eres para el equipo.
                Gracias por tu alegría, tu esfuerzo y todo lo bonito que aportas. 💖
            </div>
        </div>
        """,
...
def render_birthday_order_success(event_id: str | None, client_name: str = "") -> None:
    ...
    if event_id and st.session_state.get(BIRTHDAY_ORDER_EVENT_KEY) != event_id:
        st.balloons()
        st.toast("🎁 ¡Otro pedido especial para Griselda Carolina!")
    ...
    st.markdown(
        ...
        <div class="birthday-order-card" role="status" aria-label="Pedido registrado con felicitación">
            ...
            <div>
                <strong>Pedido{client_segment} registrado con brillo de cumpleaños.</strong><br>
                {html.escape(BIRTHDAY_VENDOR_NAME)}, este logro también merece pastel, aplausos y una sonrisa. ✨
            </div>
        </div>
        """,
        unsafe_allow_html=True,
